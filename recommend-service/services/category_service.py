...
def predict_categories(text, categories, threshold=0.60, rank=10):
    """
    Dự đoán danh mục dựa trên độ tương đồng ngữ nghĩa, tối ưu với mô tả ngắn gọn.
    
    Args:
        text (str): Văn bản đầu vào từ người dùng
        categories: Danh sách các đối tượng Category từ protobuf (recommend_pb2.Category)
    ...
    for category in categories:
        # Kết hợp title và description từ đối tượng Category, loại từ dừng
